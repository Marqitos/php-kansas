 ...
 * en una colección Kansas_Core_Slug_Collection
 * @param Kansas_Core_Slug_Interface $item
 * @return string
 */
function Kansas_Core_Slug_Collection_GetKey(Kansas_Core_Slug_Interface $item) {
	return $item->getSlug();
}
/**
 ...
 * @param mixed $offset
 */
function Kansas_Core_Slug_Collection_ParseKey($offset) {
 ...
 *
 */
class Kansas_Core_Slug_Collection 
	...
	protected function getKey($item) {			//key
		return Kansas_Core_Slug_Collection_GetKey($item);
	}
	protected function parseKey($offset) { 	//key
		return Kansas_Core_Slug_Collection_ParseKey($offset);
	}
}
